...
export const ModalCustomAlertasUsuarios = ({ show = false, onHide, id = 0 }) => {
	...
	const { DataGeneral: dataTipoAlerta, obtenerParametroPorEntidadyGrupo: obtenerTiposAlerta } =
		useTerminoStore();
			...
			<form onSubmit={onClickCustomAlertaUsuario}>
				...
				<div className="mt-3 d-flex gap-2 justify-content-end">
					<Button
						...
						onClick={onClickCustomAlertaUsuario}
						disabled={saving}
					/>
