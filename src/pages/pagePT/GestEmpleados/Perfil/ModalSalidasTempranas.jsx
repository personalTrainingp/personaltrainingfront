...
const registrarHorasEspeciales = {
  ...
  tipo_hora_especial: 850
}
export const ModalSalidasTempranas = ({show, onHide}) => {
  ...
  useEffect(() => {
      obtenerParametroPorEntidadyGrupo("horas_especiales", 850)
  }, [])
  ...
  return (
    <Dialog
        ...
        position='top'
        style={{width: '40rem'}}
        header='AGREGAR SALIDAS TEMPRANAS'
        >
          <form>
            <Row>
              <Col xxl={12}>
                <div className="mb-4">
                    <label htmlFor="periodo_desde" className="form-label">TIPO DE SALIDAS TEMPRANAS</label>
                    <Select
              ...
              <Col lg={6}>
                <div className="mb-4">
                  <label htmlFor="periodo_desde" className="form-label">MINUTOS DE SALIDA</label>
