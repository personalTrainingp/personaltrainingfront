...
//     getCustomersSmall(state) {
//         return Promise.resolve(this.getData(state).slice(0, 10));
//     },

//     getCustomersMedium(state) {
//         return Promise.resolve(this.getData(state).slice(0, 50));
//     },

//     getCustomersLarge(state) {
//         return Promise.resolve(this.getData(state).slice(0, 200));
//     },

//     getCustomersXLarge(state) {
//         return Promise.resolve(this.getData(state));
//     },
...
const useCustomerColumn = () => {
    ...
    const handleGetCustomersSmall = async () => {
        const customers = await CustomerService.getCustomersMedium(dataGastos);
        console.log(customers);
    };

    // Llama a handleGetCustomersSmall en algún evento, por ejemplo, un botón.
    return {
        handleGetCustomersSmall
    }
};
