...
export default function TableCambioPrograma() {
    ...
    return (
            <DataTable  size='small' 
                ...
                <Column header="Id"  style={{ minWidth: '10rem' }} body={IdBodyTemplate}/>
                <Column header="FECHA DE CAMBIO DE PROGRAMA"  style={{ minWidth: '10rem' }} body={ProgramaSemanasBodyTemplate}/>
                <Column header="PROGRAMA"  style={{ minWidth: '10rem' }} body={emailBodyTemplate}/>
                <Column header="HORARIO"  style={{ minWidth: '10rem' }} body={telefonoBodyTemplate}/>
                <Column header="MOTIVO"  style={{ minWidth: '10rem' }} body={distritoBodyTemplate}/>
                <Column header="OBSERVACION"  style={{ minWidth: '10rem' }} body={distritoBodyTemplate}/>
