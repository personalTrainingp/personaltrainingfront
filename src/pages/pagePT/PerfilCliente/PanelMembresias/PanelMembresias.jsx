  ...
  return (
    <div>
    {
            dataMembresias?.map((f)=>{
                ...
                const nameImgPrograma = detalle_ventamembresia.tb_ProgramaTraining?.tb_image?.name_image
                ...
                const fecha_fin = dayjs.utc(detalle_ventamembresia.fec_fin_mem).format('dddd DD [de] MMMM [del] YYYY')
