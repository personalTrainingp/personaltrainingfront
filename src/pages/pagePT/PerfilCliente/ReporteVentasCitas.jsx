...
export const ReporteVentasCitas = ({dataVenta}) => {

    const productosAgrupados = dataVenta.flatMap(venta => 
        venta.detalle_ventaCitas?.map(producto => ({
            nombre_producto: producto.tb_servicio.tipo_servicio==='NUTRI'?'NUTRICIONISTA':'TRAT. ESTETICOS',
