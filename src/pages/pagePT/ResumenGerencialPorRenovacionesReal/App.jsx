...
export const App = () => {
  const { obtenerVentas, dataVentasMembresia, dataVentasMembresiaReno } = useRenovacionesStore()
  ...
  return (
    <div>
      ...
      <App2 dataVentasMembresia={ventasMembresiaxCorteDeDia} dataVentasMembresiaReal={dataVentasMembresia}/>
    </div>
  )
}