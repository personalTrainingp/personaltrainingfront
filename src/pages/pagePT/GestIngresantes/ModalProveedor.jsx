...
export const ModalProveedor = ({status, dataProv, onHide, show, id, tipo}) => {
    ...
    const { ruc_prov, 
            ...
            const submitProveedor = async(e)=>{
                ...
                if(dataProv){
                    ...
                    actualizarProveedor(formState, dataProv.id, tipo)
                    setVisible(true);
                    onCancelForm()
                    return;
                }
                setVisible(true);
                onCancelForm()
                await startRegisterProveedor(formState, estado_prov, es_agente, selectedAvatar, id_empresa, tipo)
            }
