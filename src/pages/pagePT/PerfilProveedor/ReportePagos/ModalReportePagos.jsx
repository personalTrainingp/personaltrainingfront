...
export const ModalReportePagos = ({objContrato, monto, codigo_pago, nombre_prov, tipo_moneda, onHide, show}) => {
	...
	const provCONTRATO = {
		razon_social__prov: '',
		ruc__prov: '',
		domicilio_legal__prov: '',
		distrito_domicilio_legal__prov: '',
		representante_legal__prov: '',
		dni_representante_legal__prov: '',
		codigo_prov: '',
		email_prov: '',
		celular_prov: '',
									...
									<div className='d-flex justify-content-xxl-center'>
										<ul className='list-none w-100 font-15 font-bold'>
											...
											<li className='mb-2 p-2'>
												<Button onClick={descargarContratoProv} className='mx-2' icon={'pi pi-file-pdf fs-3'}> CONTRATO</Button>
