...
import { onDeleteOneProducto, onDeleteOneSuplemento } from '@/store/uiNuevaVenta/uiNuevaVenta';
import React from 'react'
import { Table } from 'react-bootstrap'
import { useDispatch } from 'react-redux';
import { Link } from 'react-router-dom'

export const ResumenVentaProductosSuplemento = ({dataVenta}) => {
	const dispatch = useDispatch()
	const deleteVentaProducto = (id)=>{
		dispatch(onDeleteOneSuplemento(id))
	}
  return (
    <>
