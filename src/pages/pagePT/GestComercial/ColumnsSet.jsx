...
const ActionColumn = ({row}) => {
  return (
    <>
      <Link to={`/historial-cliente/${row.original.uid}`} className="action-icon" style={{fontSize: '14px', color: 'blue', textDecoration: 'underline'}}>
        Ver Historial
      </Link>
    </>
  );
...
const columns = [
  {
    ...
    accessor: 'nombres_apellidos_cli',
    defaultCanSort: true,
  },
  {
    Header: 'Tipo de cliente',
    accessor: 'tipoCli_cli',
    defaultCanSort: true,
  },
  {
    Header: 'Distrito',
