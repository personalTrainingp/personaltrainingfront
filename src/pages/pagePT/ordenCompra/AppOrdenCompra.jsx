...
export const AppOrdenCompra = ({id_empresa}) => {
  ...
  return (
    <div>
        <div className='fs-2 text-change'>IGV ACUMULADO EN TOTAL: <NumberFormatMoney amount={dataView.reduce((total, item)=>item.monto+total, 0)-(dataView.reduce((total, item)=>item.monto+total, 0)/1.18)}/></div>
