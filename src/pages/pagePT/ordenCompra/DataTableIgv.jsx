import { useGastosStore } from '../GestGastos/useGastosStore'
...
export const DataTableIgv = ({id_facturado_por, onOpenModalGasto, sonCompras}) => {
    const {loading, dataTC, obtenerTc, obtenerFacturados } = useGastosStore()
    const { dataView } = useSelector(e=>e.EGRESOS)
    useEffect(() => {
        obtenerFacturados(id_facturado_por, sonCompras)
        obtenerTc()
    }, [id_facturado_por])
    const sortable=true;
