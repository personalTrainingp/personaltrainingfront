				...
				<div className="mt-3 chartjs-chart">
					<Row>
						<Col lg={12}>
							...
							<CardEstimado icono={'mdi mdi-arrow-down-bold-outline'} items={[{label: 'TARATA', monto: data.gastosTarata}, {label: 'REDUCTO', monto: data.gastosReducto}]} backgroundColor={'bg-danger'} title={'EGRESO'} montoSoles={<MoneyFormatter amount={data.gastosReducto+data.gastosTarata}/>}/>
