      ...
      <div style={{ margin: "32px 0" }}>
        ...
        >
          <thead className="bg-secondary text-white">
            ...
            {/* Fila 2: subtítulos NUEVOS / RENOV. / REINSC. */}
            <tr>
          ...
          <tbody>
            {filas.map((fila, ridx) => {
              ...
              return (
                <tr key={ridx} style={{ background: "#fff", fontSize: 25 }}>
                  ...
                  <td className="fw-bold" style={{ minWidth: 90 }}>
                    {fmt(totalFila, true)}
                  </td>
                  <td className="fw-bold" style={{ minWidth: 90 }}>
                    {fmt(moneyByAdvisor[norm(asesor)]?.money ?? 0, true)}
                  </td>
                  <td className="fw-bold" style={{ minWidth: 80 }}>
            ...
            <tr className="fw-bold fila-secundaria" style={{ background: "#fff", fontSize: 25 }}>
              ...
              {visiblePrograms.map(({ key: pk }, idx) => {
                ...
                return (
                  <td key={idx} className={`triptych fw-bold program-start ${isLast ? "program-end" : ""}`}>
                    <div className="tri-box">
