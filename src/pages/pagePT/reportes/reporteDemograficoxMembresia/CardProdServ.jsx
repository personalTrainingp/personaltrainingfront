    ...
    <Card>
                ...
                <div className='d-flex'>
                  <Col xxl={4} lg={4} onClick={()=>clickedItemProdServ("mem")}>
                    <ItemProdServ data={data} Inombre={"CHANGE 45"} icono={icoMem} icowid={250} icohe={70} Iabrev={"mem"} Icantidad={data?.cantidad_membresia} Itotal={data?.suma_tarifa_monto_membresia}/>
                  </Col>
                  <Col xxl={4} lg={4} onClick={()=>clickedItemProdServ("acc")}>
                    <ItemProdServ Inombre={"FS 45"} Iabrev={"acc"} icono={icoAcc} icowid={90} icohe={100} Icantidad={data?.cantidad_accesorio} Itotal={data?.suma_tarifa_monto_accesorio}/>
                  </Col>
                  <Col xxl={4} lg={4} onClick={()=>clickedItemProdServ("sup")}>
                    <ItemProdServ Inombre={"MUSCLE"} Iabrev={"sup"} icono={icoSupl} icowid={80} icohe={100} Icantidad={data?.cantidad_suplementos} Itotal={data?.suma_tarifa_monto_suplementos}/>
                  </Col>
