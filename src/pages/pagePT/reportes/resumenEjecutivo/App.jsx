...
useEffect(() => {
  ...
  if (selectedMonth === currentMonth) {
    if (cutDay > currentDay) {
      setCutDay(currentDay); // forzamos a hoy
    }
  }

  // Validación: el inicio no puede ser mayor al corte
  if (initDay > cutDay) {
    setInitDay(cutDay); // lo igualamos al corte
  }
}, [selectedMonth, cutDay, initDay]);
