...
export const ItemsxFecha = ({i}) => {
  ...
  return (
    <>
    <FormatTable3 value={'todo'} classNameTH={'text-white'} classNameTHEAD={'bg-secondary'} flattened1={flattened1} header={<> <span className='fs-1'>{i.mes} {i.anio}</span> <br/>   {fechaInicio} al {fechaFin}</>}/>
