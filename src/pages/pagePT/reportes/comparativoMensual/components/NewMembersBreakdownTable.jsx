...
import { useNewMembersBreakdown } from '../hooks/useNewMembersBreakdown';
import { fmtMoney } from '../../resumenEjecutivo/adapters/executibleLogic';

export const NewMembersBreakdownTable = ({ ventas = [], monthsData = [] }) => {

    const { repData, totals, grandTotal } = useNewMembersBreakdown(ventas, monthsData);
    ...
    return (
        <div style={styles.card}>
            <h5 style={styles.headerTitle}>Detalle Nuevos Socios por Vendedor</h5>
