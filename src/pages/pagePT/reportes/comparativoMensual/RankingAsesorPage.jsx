                        ...
                        <Card.Body>
                            ...
                            {loading ? (
                                ...
                                <div className="d-flex flex-column gap-5">
                                    <div>
                                        <h4 className="mb-3  text-center text-uppercase fw-bold text-muted" style={{fontSize: '50px'}}>Ventas Totales</h4>
                                    ...
                                    <div>
                                        <div className="mb-3  text-center text-uppercase fw-bold text-muted" style={{fontSize: '50px'}}>META</div>
                                        <MetaTable
                                            ventas={dataVentas}
                                            monthsData={monthsData}
                                            customStartDay={customStartDay}
                                    ...
                                    <div>
                                        <div className="mb-3  text-center text-uppercase fw-bold text-muted" style={{fontSize: '50px'}}>TIKTOK</div>
                                        <TiktokTable
                                            ventas={dataVentas}
                                            monthsData={monthsData}
                                            customStartDay={customStartDay}
