...
export const ReporteDemograficoCliente = ({RANGE_DATE}) => {
    ...
    const { obtenerReporteDeTotalDeVentas_PorTipoCliente_PorVendedor, reporteTotalVentasPorTipoCliente, obtenerVentas, reporteVentas, reporteDeDetalleVenta, 
      ...
      const dataDemografic_GENERO = TotalDeVentasxProdServ('mem').data?.map(n=>{
      ...
      const dataDemografic_ESTCIVIL = TotalDeVentasxProdServ('mem').data?.map(n=>{
