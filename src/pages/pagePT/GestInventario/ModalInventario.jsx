                            ...
                            <TabPanel header='MOVIMIENTO'>
                                <TabView>
                                    <TabPanel header={'ENTRADAS'}>
                                        <KardexxArticulo movimiento={'entrada'} id_articulo={data?.id} />
                                    </TabPanel>
                                    <TabPanel header={'SALIDAS'}>
                                        <KardexxArticulo movimiento={'salida'} id_articulo={data?.id} />
                                    </TabPanel>
                                    <TabPanel header={'TRANSFERENCIA'}>
                                        <KardexxArticulo movimiento={'transferencias'} id_articulo={data?.id} />
                                    </TabPanel>
                                </TabView>
                            </TabPanel>
                        </TabView>
