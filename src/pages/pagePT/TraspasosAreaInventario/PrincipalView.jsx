...
export const PrincipalView = () => {
  ...
  return (
    <>
    <PageBreadcrumb title={'SALIDA DE ITEMS'}/>
    <Row>
            <TabView>
              <TabPanel header="CHANGE THE SLIM STUDIO">
                    <DataEntrada id_enterprice={598} actionKardex={'salida'}/>
              </TabPanel>
              <TabPanel header="CIRCUS SALON">
                    <DataEntrada id_enterprice={599} actionKardex={'salida'}/>
              </TabPanel>
              <TabPanel header="CHORRILLOS">
                    <DataEntrada id_enterprice={601} actionKardex={'salida'}/>
              </TabPanel>
            </TabView>
    </Row>
    </>
