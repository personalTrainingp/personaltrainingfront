...
export const GestRegalosMembresia = () => {
  locale('es')
      ...
      <>
          {
              ...
              <Column header="Inicio del regalo" field='extension_inicio' filterField="extension_inicio" sortable style={{ width: '1rem' }} filter body={FechaInicioBodyTemplate}/>
              <Column header="Fin del regalo" field='extension_fin' filterField="extension_fin" sortable style={{ width: '1rem' }} filter body={FechaFinBodyTemplate}/>
