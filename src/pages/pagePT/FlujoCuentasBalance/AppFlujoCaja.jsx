    ...
    <div>
      ...
      <ColorEmpresa
        childrenChange={
          <TabView>
            <TabPanel header={<div className='fs-1'>2026</div>}>
              <ViewTablesFlujoCaja link={'link-change'} arrayFecha={['2026-01-01 15:45:47.6640000 +00:00', '2026-12-31 15:45:47.6640000 +00:00']} anio={2026} classNameEmpresa={'bg-change text-white'} bgPastel={'bg-change-pastel text-white'} id_empresa={598}/>
            </TabPanel>
            <TabPanel header={<div className='fs-1'>2025</div>}>
              <ViewTablesFlujoCaja link={'link-change'} arrayFecha={['2025-01-01 15:45:47.6640000 +00:00', '2025-12-31 15:45:47.6640000 +00:00']} anio={2025} classNameEmpresa={'bg-change text-white'} bgPastel={'bg-change-pastel text-white'} id_empresa={598}/>
            </TabPanel>
            <TabPanel header={<div className='fs-1'>2024</div>}>
              <ViewTablesFlujoCaja link={'link-change'} arrayFecha={['2024-01-01 15:45:47.6640000 +00:00', '2024-12-31 15:45:47.6640000 +00:00']} anio={2024} classNameEmpresa={'bg-change text-white'} bgPastel={'bg-change-pastel text-white'} id_empresa={598}/>
            </TabPanel>
            <TabPanel link={'link-change'} header={<div className='fs-1'>RESUMEN GENERAL</div>}>
        ...
        childrenCircus={
          <TabView> 
            <TabPanel header={<div className='fs-1'>2026</div>}>
              <ViewTablesFlujoCaja link={'link-circus'} textEmpresa={'text-change'} arrayFecha={['2026-01-01 15:45:47.6640000 +00:00', '2026-12-31 15:45:47.6640000 +00:00']} anio={2026} classNameEmpresa={'bg-circus text-white'} bgPastel={'bg-circus-pastel text-white'} id_empresa={601}/>
            </TabPanel>
            <TabPanel header={<div className='fs-1'>2025</div>}>
              <ViewTablesFlujoCaja link={'link-circus'} textEmpresa={'text-change'} arrayFecha={['2025-01-01 15:45:47.6640000 +00:00', '2025-12-31 15:45:47.6640000 +00:00']} anio={2025} classNameEmpresa={'bg-circus text-white'} bgPastel={'bg-circus-pastel text-white'} id_empresa={601}/>
            </TabPanel>
            <TabPanel header={<div className='fs-1'>2024</div>}>
              <ViewTablesFlujoCaja link={'link-circus'} textEmpresa={'text-change'} arrayFecha={['2024-01-01 15:45:47.6640000 +00:00', '2024-12-31 15:45:47.6640000 +00:00']} anio={2024} classNameEmpresa={'bg-circus text-white'} bgPastel={'bg-circus-pastel text-white'} id_empresa={601}/>
            </TabPanel>
            <TabPanel link={'link-circus'} header={<div className='fs-1'>RESUMEN GENERAL</div>}>
        ...
        childrenReducto={
          <TabView>
            ...
            <TabPanel header={<div className='fs-1'>RESUMEN GENERAL</div>}>
              {/* <TablesResumenTotal link={'link-isesac'} classNameEmpresa={'bg-ral text-white'} bgPastel={'bg-ral-pastel text-white'} id_empresa={599}/> */}
            </TabPanel>
          </TabView>
        }
        childrenRal = {
