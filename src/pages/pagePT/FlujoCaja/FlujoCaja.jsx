		...
		<>
            ...
            <TabView>
                <TabPanel style={{alignItems: 'flex-end', display: 'flex'}}  header={<TabIcon width={220} src='https://change-the-slim-studio-sigma.vercel.app/assets/mem_logo-be75730a.png'/>}>
                    <TabView>
                        <TabPanel header={<div className='fs-1 text-black'>2024</div>}>
                            <DatatableEgresos bgMultiValue={'#CD1014'}  arrayRangeDate={[new Date(2024, 8, 15), new Date()]} nombre_empresa={'CHANGE'} id_enterprice={598} background={'bg-primary'} anio={2024}/>
                        </TabPanel>
                        <TabPanel header={<div className='fs-1 text-black'>2025</div>}>
                            <DatatableEgresos bgMultiValue={'#CD1014'}  arrayRangeDate={[new Date(2024, 8, 15), new Date()]} nombre_empresa={'CHANGE'} id_enterprice={598} background={'bg-primary'} anio={2025}/>
                        </TabPanel>
                    </TabView>
                </TabPanel>
                <TabPanel style={{alignItems: 'flex-end', display: 'flex'}} className='mb-2' header={<TabIcon width={180} src='https://sistema-circus.vercel.app/assets/Positivo-transparente-c932a60a.png'/>}>
                    <TabView>
                        <TabPanel header={<div className='fs-1 text-black'>2024</div>}>
                            <DatatableEgresos bgMultiValue={'#EEBE00'}  arrayRangeDate={[new Date(2025, 1, 15), new Date()]} nombre_empresa={'CIRCUS'} background={'bg-circus'} id_enterprice={599} anio={2024}/>
                        </TabPanel>
                        <TabPanel header={<div className='fs-1 text-black'>2025</div>}>
                            <DatatableEgresos bgMultiValue={'#EEBE00'} arrayRangeDate={[new Date(2025, 1, 15), new Date()]} nombre_empresa={'CIRCUS'} background={'bg-circus'} id_enterprice={599} anio={2025}/>
                        </TabPanel>
                    </TabView>
                </TabPanel>
                <TabPanel style={{alignItems: 'flex-end', display: 'flex'}} className='mb-2' headerClassName="mi-tab-verde" header={<div style={{fontSize: '40px', color: '#17a700'}} className=' fw-medium'>INVERSIONES <br/> SAN EXPEDITO</div>}>
                    <TabView>
                        <TabPanel header={<div className='fs-1 text-black'>2024</div>}>
                            <DatatableEgresos bgMultiValue={'#17a700'} arrayRangeDate={[new Date(2025, 1, 15), new Date()]} background={'bg-greenISESAC'} id_enterprice={601} anio={2024} nombre_empresa={'ISE SAC'}/>
                        </TabPanel>
                        <TabPanel header={<div className='fs-1 text-black'>2025</div>}>
                            <DatatableEgresos bgMultiValue={'#17a700'} arrayRangeDate={[new Date(2025, 1, 15), new Date()]} background={'bg-greenISESAC'} id_enterprice={601} anio={2025} nombre_empresa={'ISE SAC'}/>
                        </TabPanel>
                    </TabView>
                </TabPanel>
