...
import { TrItemVentas, TrItemEgresos, TrItemUtilidad } from './TrItem'
...
export const TablesResumenTotal = ({classNameEmpresa, bgPastel, id_empresa}) => {
  ...
  return (
    <div>
        ...
        <div>
            <div style={{fontSize: '70px'}} className='text-black text-center'>UTILIDAD</div>
            <div className='tab-scroll-container'>
                <Table className='tabla-egresos fs-3' style={{ width: '100%' }} bordered>
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <TrItemUtilidad classNameTotal={'text-center border-left-10 border-right-10'} label='2026' arrayFechas={anio2026} id_empresa={id_empresa}/>
                        <TrItemUtilidad classNameTotal={'text-center border-left-10 border-right-10'} label='2025' arrayFechas={anio2025} id_empresa={id_empresa}/>
                        <TrItemUtilidad classNameTotal={'text-center border-left-10 border-right-10'} label='2024' arrayFechas={anio2024} id_empresa={id_empresa}/>
                        <TrItemUtilidad classNameTotal={'text-center border-left-10 border-right-10 border-bottom-10'} label='TOTAL' arrayFechas={anioTotal} id_empresa={id_empresa}/>
                    </tbody>
                </Table>
            </div>
        </div>
