    ...
    
                    {
                        ...
                        >
                            <thead className="bg-primary">
                                <tr>
                                <th className='text-black fs-3'><span className='p-1 rounded rounded-3' style={{width: '260px'}}>{i+1}. {g.grupo}</span></th>
                            ...
                            <tbody>
                                {
                                    g.conceptos.map((c, index)=>(
                                        <tr>
                                            ...
                                            <td className='text-center'><div className={`cursor-text-primary ${c.items[1].monto_total<=0?'text-danger':'text-black'}`} onClick={()=>onOpenModalDetallexCelda({...c.items[1], concepto: c.concepto, grupo: g.grupo})}><NumberFormatMoney amount={c.items[1].monto_total}/></div></td>
                                            <td className='text-center'><div className={`cursor-text-primary ${c.items[2].monto_total<=0?'text-danger':'text-black'}`} onClick={()=>onOpenModalDetallexCelda({...c.items[2], concepto: c.concepto, grupo: g.grupo})}><NumberFormatMoney amount={c.items[2].monto_total}/></div></td>
                                            <td className='text-center'><div className={`cursor-text-primary ${c.items[3].monto_total<=0?'text-danger':'text-black'}`} onClick={()=>onOpenModalDetallexCelda({...c.items[3], concepto: c.concepto, grupo: g.grupo})}><NumberFormatMoney amount={c.items[3].monto_total}/></div></td>
                                            <td className='text-center'><div className={`cursor-text-primary ${c.items[4].monto_total<=0?'text-danger':'text-black'}`} onClick={()=>onOpenModalDetallexCelda({...c.items[4], concepto: c.concepto, grupo: g.grupo})}><NumberFormatMoney amount={c.items[4].monto_total}/></div></td>
                                            <td className='text-center'><div className={`cursor-text-primary ${c.items[5].monto_total<=0?'text-danger':'text-black'}`} onClick={()=>onOpenModalDetallexCelda({...c.items[5], concepto: c.concepto, grupo: g.grupo})}><NumberFormatMoney amount={c.items[5].monto_total}/></div></td>
                                            <td className='text-center'><div className={`cursor-text-primary ${c.items[6].monto_total<=0?'text-danger':'text-black'}`} onClick={()=>onOpenModalDetallexCelda({...c.items[6], concepto: c.concepto, grupo: g.grupo})}><NumberFormatMoney amount={c.items[6].monto_total}/></div></td>
                                            <td className='text-center'><div className={`cursor-text-primary ${c.items[7].monto_total<=0?'text-danger':'text-black'}`} onClick={()=>onOpenModalDetallexCelda({...c.items[7], concepto: c.concepto, grupo: g.grupo})}><NumberFormatMoney amount={c.items[7].monto_total}/></div></td>
                                            <td className='text-center'><div className={`cursor-text-primary ${c.items[8].monto_total<=0?'text-danger':'text-black'}`} onClick={()=>onOpenModalDetallexCelda({...c.items[8], concepto: c.concepto, grupo: g.grupo})}><NumberFormatMoney amount={c.items[8].monto_total}/></div></td>
                                            <td className='text-center'><div className={`cursor-text-primary ${c.items[9].monto_total<=0?'text-danger':'text-black'}`} onClick={()=>onOpenModalDetallexCelda({...c.items[9], concepto: c.concepto, grupo: g.grupo})}><NumberFormatMoney amount={c.items[9].monto_total}/></div></td>
                                            <td className='text-center'><div className={`cursor-text-primary ${c.items[10].monto_total<=0?'text-danger':'text-black'}`} onClick={()=>onOpenModalDetallexCelda({...c.items[10], concepto: c.concepto, grupo: g.grupo})}><NumberFormatMoney amount={c.items[10].monto_total}/></div></td>
                                            <td className='text-center'><div className={`cursor-text-primary ${c.items[11].monto_total<=0?'text-danger':'text-black'}`} onClick={()=>onOpenModalDetallexCelda({...c.items[11], concepto: c.concepto, grupo: g.grupo})}><NumberFormatMoney amount={c.items[11].monto_total}/></div></td>
