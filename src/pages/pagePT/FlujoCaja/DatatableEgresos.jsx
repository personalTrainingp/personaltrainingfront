                            ...
                            <tbody>
                                {
                                    g.conceptos.map((c, index)=>(
                                        <tr>
                                            ...
                                            <td className='text-center'><div className='cursor-text-primary' onClick={()=>onOpenModalDetallexCelda({...c.items[10], concepto: c.concepto, grupo: g.grupo})}><NumberFormatMoney amount={c.items[10].monto_total}/></div></td>
                                            <td className='text-center'><div className='cursor-text-primary' onClick={()=>onOpenModalDetallexCelda({...c.items[11], concepto: c.concepto, grupo: g.grupo})}><NumberFormatMoney amount={c.items[11].monto_total}/></div></td>
