                            ...
                            <tbody>
                                {
                                    g.conceptos.map((c, index)=>(
                                        <tr>
                                            ...
                                            <td className='text-center'><div className='cursor-text-primary' onClick={()=>onOpenModalDetallexCelda({...c.items[0], concepto: c.concepto, grupo: g.grupo})}><NumberFormatMoney amount={c.items[0].monto_total}/><br/><NumberFormatMoney amount={c.items[0].monto_total}/></div></td>
                                            <td className='text-center'><div className='cursor-text-primary' onClick={()=>onOpenModalDetallexCelda({...c.items[1], concepto: c.concepto, grupo: g.grupo})}><NumberFormatMoney amount={c.items[1].monto_total}/><br/><NumberFormatMoney amount={c.items[1].monto_total}/></div></td>
                                            <td className='text-center'><div className='cursor-text-primary' onClick={()=>onOpenModalDetallexCelda({...c.items[2], concepto: c.concepto, grupo: g.grupo})}><NumberFormatMoney amount={c.items[2].monto_total}/><br/><NumberFormatMoney amount={c.items[2].monto_total}/></div></td>
                                            <td className='text-center'><div className='cursor-text-primary' onClick={()=>onOpenModalDetallexCelda({...c.items[3], concepto: c.concepto, grupo: g.grupo})}><NumberFormatMoney amount={c.items[3].monto_total}/><br/><NumberFormatMoney amount={c.items[3].monto_total}/></div></td>
                                            <td className='text-center'><div className='cursor-text-primary' onClick={()=>onOpenModalDetallexCelda({...c.items[4], concepto: c.concepto, grupo: g.grupo})}><NumberFormatMoney amount={c.items[4].monto_total}/><br/><NumberFormatMoney amount={c.items[4].monto_total}/></div></td>
                                            <td className='text-center'><div className='cursor-text-primary' onClick={()=>onOpenModalDetallexCelda({...c.items[5], concepto: c.concepto, grupo: g.grupo})}><NumberFormatMoney amount={c.items[5].monto_total}/><br/><NumberFormatMoney amount={c.items[5].monto_total}/></div></td>
                                            <td className='text-center'><div className='cursor-text-primary' onClick={()=>onOpenModalDetallexCelda({...c.items[6], concepto: c.concepto, grupo: g.grupo})}><NumberFormatMoney amount={c.items[6].monto_total}/><br/><NumberFormatMoney amount={c.items[6].monto_total}/></div></td>
                                            <td className='text-center'><div className='cursor-text-primary' onClick={()=>onOpenModalDetallexCelda({...c.items[7], concepto: c.concepto, grupo: g.grupo})}><NumberFormatMoney amount={c.items[7].monto_total}/><br/><NumberFormatMoney amount={c.items[7].monto_total}/></div></td>
                                            <td className='text-center'><div className='cursor-text-primary' onClick={()=>onOpenModalDetallexCelda({...c.items[8], concepto: c.concepto, grupo: g.grupo})}><NumberFormatMoney amount={c.items[8].monto_total}/><br/><NumberFormatMoney amount={c.items[8].monto_total}/></div></td>
                                            <td className='text-center'><div className='cursor-text-primary' onClick={()=>onOpenModalDetallexCelda({...c.items[9], concepto: c.concepto, grupo: g.grupo})}><NumberFormatMoney amount={c.items[9].monto_total}/><br/><NumberFormatMoney amount={c.items[9].monto_total}/></div></td>
                                            <td className='text-center'><div className='cursor-text-primary' onClick={()=>onOpenModalDetallexCelda({...c.items[10], concepto: c.concepto, grupo: g.grupo})}><NumberFormatMoney amount={c.items[10].monto_total}/><br/><NumberFormatMoney amount={c.items[10].monto_total}/></div></td>
                                            <td className='text-center'><div className='cursor-text-primary' onClick={()=>onOpenModalDetallexCelda({...c.items[11], concepto: c.concepto, grupo: g.grupo})}><NumberFormatMoney amount={c.items[11].monto_total}/><br/><NumberFormatMoney amount={c.items[11].monto_total}/></div></td>
                                            <td className='text-center'><div className='cursor-text-primary' onClick={()=>onOpenModalDetallexCelda({...c.items[12], concepto: c.concepto, grupo: g.grupo})}><NumberFormatMoney amount={
