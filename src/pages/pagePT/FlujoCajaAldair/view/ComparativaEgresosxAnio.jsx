...
export const ComparativaEgresosxAnio = ({id_empresa}) => {
  ...
  const dataVentas = dataGastosxFecha.flujoxGrupo.filter(f=>f.id!==97 && f.id!==153 && f.id!==103 && f.grupo!=="TARJETA CREDITO VISA BBVA"&& f.id!==150 ).flatMap(e=>e.itemsxDia).flatMap(e=>e.items)
  useEffect(() => {
